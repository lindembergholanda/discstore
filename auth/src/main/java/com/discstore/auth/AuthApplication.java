...
import com.discstore.auth.entity.Permission;
import com.discstore.auth.entity.User;
import com.discstore.auth.repository.PermissionRepository;
import com.discstore.auth.repository.UserRepository;
...
public class AuthApplication {
	...
	private void initUsers(UserRepository userRepository, PermissionRepository permissionRepository,
		...
		User find = userRepository.findByUserName("lindemberg");
		if(find == null) {
